...
function generatePassword() {
    ...
    do {
        passwordLength = window.prompt("How many characters? between 8 and 128");
...
function characterPrompt(passwordLength) {
    ...
    var possibleArray = []
    var resultArray = []
    //part of the recursive loop issue fix
    do {
        // Array of Uppercase
        ...
        //this is to get rid of the recursive loop that I had.
    } while (upperCase === false && lowerCase === false && numerical === false && specialCharacter === false)

    for (i = 0; i < passwordLength; i++) {
        resultArray.push(random(possibleArray));
    }
    //maintain the must include portion challenge
